...
export default function PlasticPage() {
  ...
  const content = dict.salesPages.plastic;
  const caseStudies = dict.caseStudies.filter((c) => c.niche === "plastic");
  ...
  return (
    <div className="space-y-10 md:space-y-12">
        ...
        <div className="grid gap-4 md:grid-cols-3">
          {caseStudies.map((cs, index) => (
            ...
            >
              ...
              <Link
                href={`/${locale}/case-studies/plastic/${cs.slug}`}
      ...
      <ApplicationForm locale={locale} sourcePage="plastic" />
    </div>
  );
}
